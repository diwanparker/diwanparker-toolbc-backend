        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientProfiles_DoctorProfiles_AssignedDoctorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersistentCough = table.Column<bool>(type: "boolean", nullable: false),
                    FeverOrChills = table.Column<bool>(type: "boolean", nullable: false),
                    NightSweats = table.Column<bool>(type: "boolean", nullable: false),
                    WeightLossOrLowAppetite = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SymptomLogs_PatientProfiles_PatientProfileId",
                        column: x => x.PatientProfileId,
                        principalTable: "PatientProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicineSummary = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicationDoseLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicationDoseLogs_TreatmentPlans_TreatmentPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationDoseLogs_TreatmentPlanId",
                table: "MedicationDoseLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientProfiles_AssignedDoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SymptomLogs_PatientProfileId",
                table: "SymptomLogs",
                column: "PatientProfileId");
